...
<!--			<li role="presentation"><a data-target="#thumb-setting-playback" aria-controls="thumb-setting-playback" role="tab" data-toggle="tab" class="es-tooltip" title="--><?php //echo JText::_('JSN_EASYSLIDER_SLIDER_SLIDE_INSPECTOR_PLAYBACK_DESC', true);?><!--"><span class="fa fa-play-circle"></span></a></li>-->
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="thumb-setting-video">
				<div class="row">
                    <div class="col-xs-2">
                        <input type="radio" class="form-control input-xs input-normal" name="video-select" data-bind="background.video.selector" value="provider">
                    </div>
				...
				<div class="row">
                    <div class="col-xs-2">
                        <input type="radio" class="form-control input-xs input-normal" name="video-select" data-bind="background.video.selector" value="local">
                    </div>
