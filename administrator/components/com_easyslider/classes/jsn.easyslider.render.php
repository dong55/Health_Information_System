				...
				<div class="jsn-es-stage">
					<ul class="jsn-es-slides">
						<li class="jsn-es-slide">
							...
							<div class="jsn-es-background slide-background"></div>
...
//        $content .= '<div class="render-text" style="position: fixed;top: 0;left: -1px; width: 1px; height: 1px;"></div>';
    ...
    protected function _loadAssets()
    {
        ...
        $document->addStyleSheet($pathOnly . '/plugins/system/easyslider/assets/css/easyslider.css?v='. time());
        ...
        $document->addScript($pathOnly . '/plugins/system/easyslider/assets/js/easyslider.js?v='. time());
    }
}