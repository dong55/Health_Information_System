...
class PlgButtonSourcererPopup
{
	...
	function render()
	{
		...
		NNFrameworkFunctions::script('nnframework/script.min.js', '16.3.18690');
		NNFrameworkFunctions::stylesheet('nnframework/popup.min.css', '16.3.18690');
		NNFrameworkFunctions::stylesheet('nnframework/style.min.css', '16.3.18690');
		...
		NNFrameworkFunctions::script('sourcerer/script.min.js', '5.3.2');
		NNFrameworkFunctions::stylesheet('sourcerer/popup.min.css', '5.3.2');
