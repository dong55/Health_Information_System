...
switch ($item->browserNav) :
	...
	case 1:
		// _blank
?><a <?php echo $class; ?>href="<?php echo $flink; ?>" target="_blank" <?php echo $title; ?>><span class="sdt_active"></span><span class="sdt_wrap"><span class="sdt_link"><?php echo $linktype; ?></span><span class="sdt_descr"><?php echo $title; ?></span></span></a><?php
		break;
	case 2:
		// window.open
